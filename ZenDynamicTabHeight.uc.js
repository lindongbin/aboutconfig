...
(function() {
  ...
  function initializeUI() {
    ...
    tabCount = Array.from(tabContainer.allTabs).filter(tab => !tab.closing).length;
    styleEl = document.createElement('style');
    styleEl.textContent = `
      zen-workspace { min-height: 100vh !important; padding-bottom: 15vh !important; }
      .zen-current-workspace-indicator, #zen-sidebar-foot-buttons, #zen-media-controls-toolbar { display: none !important; }
